...
2-Abra o terminal e siga até o diretório onde os arquivos foram baixados;
3-Utilize o comando 'make clean'(sem aspas) para limpar todos os arquivos objetos e o executável;
4-Utilize o comando 'make'(sem aspas) para gerar arquivos .o e o executável;
5-Ainda no terminal, siga até o diretório 'bin'(sem aspas) e nele, encontrará o exercutável 'Programa';
6-Utilize o seguinte comando para executar o programa no terminal: './Programa'(sem aspas);
